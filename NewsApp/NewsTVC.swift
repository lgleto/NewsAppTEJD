...
class NewsTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelTitle.text = newsArray[indexPath.row].title
        cell.labelDescription.text = newsArray[indexPath.row].description
        // Configure the cell...
        if let urlStr = newsArray[indexPath.row].urlToImage {
